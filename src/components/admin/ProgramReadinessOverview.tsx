...
export const ProgramReadinessOverview: React.FC<ProgramReadinessOverviewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="bg-slate-900 rounded-2xl p-6 sm:p-7 text-white border border-slate-800 shadow-md relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="text-[11px] text-slate-400 font-mono">
                Tarikh: {formatDate(program.startDate)} — {formatDate(program.endDate)}
              </span>
            </div>
          ...
          <div className="flex items-center gap-4 bg-slate-800/90 backdrop-blur-md p-4 rounded-xl border border-slate-700 shrink-0">
            <div className="relative w-18 h-18 sm:w-20 sm:h-20 flex items-center justify-center">
              ...
              <div className="absolute text-center">
                <span className="font-bold text-lg sm:text-xl font-mono text-white">
              ...
              <div className="flex items-center gap-1.5">
                {stats.isReadyForLaunch ? (
                  <span className="text-emerald-400 font-bold flex items-center gap-1">
                    ...
                    <span>Bersedia Sepenuhnya</span>
                  </span>
                ) : stats.openAssistanceCount > 0 ? (
                  <span className="text-red-400 font-bold flex items-center gap-1">
                    <AlertTriangle className="w-3.5 h-3.5" />
                    <span>Perlu Tindakan Urusetia</span>
                  </span>
                ) : (
                  <span className="text-amber-400 font-bold flex items-center gap-1">
                    <Clock className="w-3.5 h-3.5" />
                    <span>Dalam Persediaan</span>
                  </span>
                )}
              </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mt-6 pt-6 border-t border-slate-800 text-xs">
          <div className="bg-slate-800/60 p-3.5 rounded-xl border border-slate-700/60">
            <span className="text-slate-400 block text-[9px] font-bold uppercase tracking-widest">
              1. Siap Sepenuhnya
            </span>
      ...
      {stats.openAssistanceCount > 0 && (
        <div className="p-4 rounded-xl bg-red-600 text-white flex items-center justify-between gap-4 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-red-500 flex items-center justify-center shrink-0">
              <ShieldAlert className="w-5 h-5 text-white" />
            </div>
            <div>
              <p className="font-bold text-xs uppercase tracking-widest text-red-100">
          ...
          <button
            ...
            className="py-2 px-3.5 rounded-lg bg-white hover:bg-slate-100 text-red-700 font-bold text-xs shrink-0 shadow-xs transition flex items-center gap-1.5"
          >
            ...
            >
              <div>
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  <span className="font-bold text-sm sm:text-base font-mono text-slate-900 dark:text-white shrink-0">
                    {unit.progress}%
                  </span>
                </div>
                ...
                <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700/80 mb-3 flex items-center justify-between text-xs">
                  ...
                  <button
                    ...
                    className="py-1 px-2.5 rounded-lg text-xs font-semibold bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-100 border border-slate-200 dark:border-slate-600 transition shrink-0 flex items-center gap-1"
                  >
